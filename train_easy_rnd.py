...
from q_function_easy import DQNQFunctionEasy
from rnd_network_easy import RNDModelEasy
from rnd_agent_easy import RNDAgentEasy
...
def main():
    ...
    parser.add_argument('--normalization_pre_steps', type=int, default=5000,
    ...
    if isinstance(action_space, spaces.Box):
        ...
        q_func = DQNQFunctionEasy(obs_size, n_actions)
    ...
    agent = Agent(q_func, rnd, opt, opt_rnd, rbuf, gpu=args.gpu, gamma=0.99,
                  gamma_i=0.9, n_action=n_actions,
